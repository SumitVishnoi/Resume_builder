...
export async function POST(req: NextRequest) {
    try {
        ...
        const {experience, jobRole, techStack, yearsOfExperience} = body

        if(!experience || !jobRole || !techStack || !yearsOfExperience) {
        ...
        console.log("error in experience description", error)
        return NextResponse.json<ApiResponse>({
            success: false,
