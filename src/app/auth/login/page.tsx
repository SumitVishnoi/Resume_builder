        ...
        <div className="w-full max-w-[400px] space-y-8">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-sm text-[#6B7280]">
              ...
              <Link href="/auth/register" className="text-[#7C3AED] font-medium hover:text-[#6D28D9] transition-colors">
                Create one free
              </Link>
            </p>
          </div>
          ...
          <p className="text-center text-[11px] text-[#C4C4CC]">
            ...
            <Link href="/terms" className="underline hover:text-[#9CA3AF] transition-colors">
              Terms
            </Link>{" "}
            and{" "}
            <Link href="/privacy" className="underline hover:text-[#9CA3AF] transition-colors">
              Privacy Policy
            </Link>
            .
          </p>
